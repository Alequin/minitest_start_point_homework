...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    result = calc_cube_volume(5)
    assert_equal(125, result)
  end

  # Returns the volume of a sphere to 1dp
  def test_volume_of_sphere()
    result = calc_sphere_volume(5)
    assert_equal(523.6, result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    result_1 = fahrenheit_to_celsius(32)
    assert_equal(0, result_1)
    result_2 = fahrenheit_to_celsius(100)
    assert_equal(37.8, result_2)
  end
